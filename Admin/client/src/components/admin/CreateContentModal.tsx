...
import type { MediaModule } from "@/lib/media-assets";
...
export default function CreateContentModal({
  ...
  const getMediaModule = (): MediaModule => {
    const modules: Record<ContentType, MediaModule> = {
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <MediaAssetPicker
                      moduleName={getMediaModule()}
                      value={field.value}
                      onChange={field.onChange}
                      aspect={contentType === "team" ? "portrait" : contentType === "partner" ? "logo" : "video"}
                    />
                  </FormControl>
                  <FormMessage />
                </FormItem>
