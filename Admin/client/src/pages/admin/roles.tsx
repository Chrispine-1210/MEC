    ...
    },
    {
      ...
      render: (_: any, row: any) => (
        <div className="flex gap-2">
          ...
          <Button variant="ghost" size="sm" onClick={() => handleDelete(row.id)} title="Delete role" className="text-destructive hover:text-destructive hover:bg-destructive/10">
              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
                <FormField control={form.control} name="name" render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input {...field} placeholder="e.g. Content Editor, Reviewer" />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )} />
