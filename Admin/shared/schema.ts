...
export const partnerInstitutions = pgTable("partner_institutions", {
  ...
  linkedEvents: jsonb("linked_events"),
  linkedSponsorships: jsonb("linked_sponsorships"),
  linkedOpportunities: jsonb("linked_opportunities"),
  partnershipHistory: jsonb("partnership_history"),
...
// User Roles table (for assigning multiple roles to users)
