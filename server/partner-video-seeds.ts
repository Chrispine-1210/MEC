...
export const partnerHeroVideoSeeds: PartnerHeroVideoSeed[] = [
  ...
  },
  {
    ...
    description:
      "GEDU Global Education connects students with international study destinations and institutions across a growing global education network.",
    website: "https://gedu.global",
    country: "Global",
    logoUrl: "partners/partners-2.jpg",
    partnershipType: "Global Education Partner",
    videoUrl: "https://www.youtube.com/watch?v=fF8ysli2hAw",
    videoTitle: "GEDU Global Education Partner Network",
    videoDescription:
      "A global education partner preview for students considering international study routes through GEDU institutions.",
    isFeatured: true,
  },
];
