...
export type ApplicationMeta = {
  ...
  experienceHistory?: Array<Record<string, unknown>>;
  references?: Array<Record<string, unknown>>;
  roleAnswers?: Record<string, unknown>;
  cvBuilderSnapshot?: Record<string, unknown>;
  atsScore?: number;
  evaluationScores?: Array<Record<string, unknown>>;
...
const DEFAULT_ROLES: AdminRole[] = [
  ...
  },
  {
    id: "editor",
    name: "Editor",
    description: "Can publish content and review operational workflows.",
    permissions: [
      "view_dashboard",
      "manage_events",
      "manage_scholarships",
  ...
  },
  {
    id: "admin",
    name: "Administrator",
    description: "Can manage operational content, users, applications, analytics, and security workflows.",
    permissions: [
      "view_dashboard",
      "manage_events",
      "manage_scholarships",
